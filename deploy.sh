...
flutter build web --release --base-href="/CommuteWise/" #change '/myappRepo/' to the name of the github repo of your project
...
echo "Deployment complete! Visit: https://karthik-durairaj.github.io/CommuteWise/" #change to your username in the link